...
public class membersDto {
	...
	public String getMem_others01() {return mem_key;}
	public void setMem_others01(String mem_others01) {this.mem_key = mem_others01;}
	...
	public String toString() {
		return "membersDto [mem_no=" + mem_no + ", mem_id=" + mem_id + ", mem_pw=" + mem_pw + ", mem_status="
				...
				+ mem_homepage + ", mem_others01=" + mem_key + ", mem_others02=" + mem_others02 + "]";
	}
