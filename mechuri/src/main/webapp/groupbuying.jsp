...
<body>
	...
	<div data-layout="_r">
		<div data-layout="ch8 ec4">
			<a href="#" class="MOD_FEATURE_Container"> <img
				class="MOD_FEATURE_Picture" src="images/aromatic23.jpg" alt="">
				<div class="MOD_FEATURE_TextContainer">
					<p class="MOD_FEATURE_Title" data-theme="_ts2">맘 앤 베이비 밤</p>
					<p class="MOD_FEATURE_Description">상품명:맘 앤 베이비 밤 <br> 브랜드:아로마틱 <br> 
		...
		<div data-layout="ch8 ec4">
			<a href="#" class="MOD_FEATURE_Container"> <img
				class="MOD_FEATURE_Picture" src="images/dokdo2.jpg" alt="">
				<div class="MOD_FEATURE_TextContainer">
					<p class="MOD_FEATURE_Title" data-theme="_ts2">독도토너</p>
		...
		<div data-layout="ch8 ec4">
			<a href="#" class="MOD_FEATURE_Container"> <img
				class="MOD_FEATURE_Picture" src="images/hera c.jpg" alt="">
				<div class="MOD_FEATURE_TextContainer">
					<p class="MOD_FEATURE_Title" data-theme="_ts2">블랙 쿠션</p>
		...
		<div data-layout="ch8 ec4">
			<a href="#" class="MOD_FEATURE_Container"> <img
				class="MOD_FEATURE_Picture" src="images/estee.jpg" alt="">
				<div class="MOD_FEATURE_TextContainer">
					<p class="MOD_FEATURE_Title" data-theme="_ts2">더블웨어 파운데이션</p>
	...
	<div data-layout="ch8 ec4">
		<a href="#" class="MOD_FEATURE_Container"> <img
			class="MOD_FEATURE_Picture" src="images/mac shadow.jpg" alt="">
			<div class="MOD_FEATURE_TextContainer">
				<p class="MOD_FEATURE_Title" data-theme="_ts2">아이섀도</p>
	...
	<div data-layout="ch8 ec4">
		<a href="#" class="MOD_FEATURE_Container"> <img
			class="MOD_FEATURE_Picture" src="images/hanu3.jpg" alt="">
			<div class="MOD_FEATURE_TextContainer">
				<p class="MOD_FEATURE_Title" data-theme="_ts2">어린쑥 수분진정</p>
	...
	<div data-layout="ch8 ec4">
		<a href="#" class="MOD_FEATURE_Container"> <img
			class="MOD_FEATURE_Picture" src="images/nars lip.jpg" alt="">
			<div class="MOD_FEATURE_TextContainer">
				<p class="MOD_FEATURE_Title" data-theme="_ts2">울트라HD 립펜슬</p>
	...
	<div data-layout="ch8 ec4">
		<a href="#" class="MOD_FEATURE_Container"> <img
			class="MOD_FEATURE_Picture" src="images/onthebody.jpg" alt="">
			<div class="MOD_FEATURE_TextContainer">
				<p class="MOD_FEATURE_Title" data-theme="_ts2">데일리선크림 라이언</p>
